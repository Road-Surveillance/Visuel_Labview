...
def detect_and_export_from_path(image_path, obj_detector):
    """
...
if __name__ == "__main__":
    ...
    if os.path.isdir(opt.source):
        ...
        for img_name in img_names:
            ...
            detect_and_export_from_path(img_path, obj_detector)
    else:
        detect_and_export_from_path(opt.source, obj_detector)
